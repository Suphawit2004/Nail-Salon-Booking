...
export default function ReservePage(){
  ...
  const handleConfirm = async ()=>{
    if(!service) return alert("กรุณาเลือกบริการจากหน้าเลือกบริการก่อน");
  ...
  return (
    <main className="mx-auto min-h-screen max-w-screen-sm bg-white text-gray-800">
      ...
      <section className="px-4 pt-4 pb-24">
        ...
        {!service ? (
          <div className="rounded-3xl border border-pink-100 p-4 bg-pink-50/60">
            <p className="text-sm text-gray-600">ยังไม่ได้เลือกบริการ</p>
          ...
          <div className="rounded-3xl border border-pink-100 shadow-sm bg-pink-50/60 p-4">
            ...
            <div className="mt-4 flex justify-end gap-2">
              ...
              <button onClick={handleConfirm} className="rounded-xl bg-pink-400 text-white px-6 py-2 text-sm font-semibold hover:bg-pink-500 active:bg-pink-600 shadow-sm">ยืนยันการจอง</button>
            </div>
          </div>
        )}
      </section>
