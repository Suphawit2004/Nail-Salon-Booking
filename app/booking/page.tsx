            ...
            <div key={s.id} className="rounded-3xl border border-pink-100 shadow-sm bg-white/80 backdrop-blur-sm p-3 sm:p-4 flex gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="mt-2 flex justify-end gap-2">
                  <Link href={`/reserve?serviceId=${s.id}`} className="inline-flex items-center justify-center rounded-xl px-4 py-2 text-xs font-semibold text-white bg-pink-400 hover:bg-pink-500 active:bg-pink-600 transition-colors shadow-sm">จอง</Link>
                </div>
              </div>
            </div>
          ))}
